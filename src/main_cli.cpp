...
void renderMainWindow() {
    ...
    if (ImGui::BeginMenuBar()) {
        if (ImGui::BeginMenu("File")) {
            if (ImGui::MenuItem("Load Genome...")) {
                // TODO: File dialog
            }
            if (ImGui::MenuItem("Save Genome...")) {
                // TODO: File dialog
            }
            ImGui::Separator();
    ...
    if (g_state.show_binding_results) {
        ...
        // Binding category
        int category = physics::BindingAssay::getBindingCategory(g_state.binding_energy);
        ImGui::Text("Category: %s", 
            physics::BindingAssay::getBindingCategoryName(category).c_str());
